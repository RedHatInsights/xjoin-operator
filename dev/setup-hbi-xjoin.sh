...
# This script deploys host-inventory, xjoin, and its dependencies required for
# keeping the DB and Elasticsearch index ensynch.  It does not install any 
# additional components required by Cyndi
