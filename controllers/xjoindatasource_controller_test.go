...
var createValidDataSource = func(name string, namespace string) {
...
var reconcileDataSource = func(name string, namespace string) v1alpha1.XJoinDataSource {
...
var reconcileDataSourceToBeNew = func(name string, namespace string) v1alpha1.XJoinDataSource {
	createdDatasource := reconcileDataSource(name, namespace)
...
var reconcileDataSourceToBeValid = func(name string, namespace string) v1alpha1.XJoinDataSource {
	reconcileDataSource(name, namespace)
	createdDatasource := reconcileDataSource(name, namespace)
...
var _ = Describe("XJoinDataSource", func() {
	...
	Context("Reconcile", func() {
		It("Should create a XJoinDataSourcePipeline", func() {
			...
			createdDataSource := reconcileDataSourceToBeNew(dataSourceName, namespace)
